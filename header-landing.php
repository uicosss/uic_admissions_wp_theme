...
<head>
	...
	<script async="async" src="https://applynow.uic.edu/ping">
		/**/
	</script>
</head>
	...
	<header class="uic-section uic-header" aria-label="Site Header">
		<div class="uic-section__container">
			<div class="uic-section__inner uic-section__inner--never-padding">
				...
				<?php
				// Landing Header variables for components below
				global $post;
				...
				if ($current_page_id) {
					$mini_navbar_link = get_field('mini_navbar_link', $current_page_id);
				}
				?>
